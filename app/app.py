...
LAST_LOG_HOUR = 24      # treated as "up to 23:xx"
...
def should_auto_log_for_mode(mode: str, clock_dt: datetime) -> bool:
    """
    Auto log window: 08:00..23:59 (מה שמכונה אצלך 08–24)
    לא מפספס: מספיק שתהיה קריאה אחת בתוך השעה כדי שנכתוב פעם אחת לשעה.
    """
    if clock_dt is None:
        return False
...
def start_timer(i):
    ...
    # write start time once/day (row 4)
...
# Optional: quick manual calendar test (does not change timers)
